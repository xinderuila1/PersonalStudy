...
global g_JiraToken
g_JiraToken = jira._session.cookies.get('atlassian.xsrf.token')
#//////////////////////////////////////////
...
#for test
searchIssue("GTJ-35528")
#global g_Issue
#transitions = jira.transitions(g_Issue)
#jira.transition_issue(g_Issue, '51', {'Status':{'id': '10009'}})
#global g_Issue
#g_Issue.update({'status': {'id': '1'}})
